...
##
## Debug
ProjectName            :=04-03-print
ConfigurationName      :=Debug
WorkspacePath          :=C:/ti-software/v1oopc-examples
ProjectPath            :=C:/ti-software/v1oopc-examples/04-03-print
...
ObjectsFileList        :="04-03-print.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-examples/04-03-print/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/line_print.cpp$(ObjectSuffix): line_print.cpp $(IntermediateDirectory)/line_print.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-examples/04-03-print/line_print.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/line_print.cpp$(ObjectSuffix) $(IncludePath)
