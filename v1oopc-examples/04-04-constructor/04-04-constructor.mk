...
##
## Debug
ProjectName            :=04-04-constructor
ConfigurationName      :=Debug
WorkspacePath          :=C:/ti-software/v1oopc-examples
ProjectPath            :=C:/ti-software/v1oopc-examples/04-04-constructor
...
ObjectsFileList        :="04-04-constructor.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-examples/04-04-constructor/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/line_print.cpp$(ObjectSuffix): line_print.cpp $(IntermediateDirectory)/line_print.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-examples/04-04-constructor/line_print.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/line_print.cpp$(ObjectSuffix) $(IncludePath)
