...
##
## Debug
ProjectName            :=09-05-with-operator
ConfigurationName      :=Debug
WorkspacePath          :=C:/ti-software/v1oopc-examples
ProjectPath            :=C:/ti-software/v1oopc-examples/09-05-with-operator
...
ObjectsFileList        :="09-05-with-operator.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/ti-software/v1oopc-examples/09-05-with-operator/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
