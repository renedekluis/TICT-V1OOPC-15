...
##
## Debug
ProjectName            :=11-01-c-zero
ConfigurationName      :=Debug
WorkspacePath          :=C:/ti-software/v1oopc-examples
ProjectPath            :=C:/ti-software/v1oopc-examples/11-01-c-zero
...
ObjectsFileList        :="11-01-c-zero.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/ti-software/v1oopc-examples/11-01-c-zero/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
